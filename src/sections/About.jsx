            ...
            />
                ...
                <div className="grid-black-color grid-3">
                    <div className="z-10 w-[50%]">
                        ...
                        <p className="subtext">
                            I currently reside in Mumbai, Maharashtra and am open to working both in-office and remotely.
                        </p>
                    </div>
                    <figure className="absolute left-[30%] top-[2%]">
                        <Globe />
                    </figure>
                </div>
                {/* Grid 4 */}
                <div className="grid-special-color grid-4">
                    <div className="flex flex-col items-center justify-center gap-4 size-full ">
                        <p className="text-center headtext">
                            Are you looking for a Front-End Dev?
                        </p>
                        <CopyEmailButton />
                    </div>
                </div>
                ...
                <div className="grid-default-color grid-5">
                  <div className="z-10 w-[50%]">
                    ...
                    <p className="subtext">
                      I specialize in a variety of languages, frameworks, and tools that allow me to build robust and scallable applications.
                    </p>
                  </div>
